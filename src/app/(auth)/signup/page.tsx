        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex flex-1 bg-ink-950 items-center justify-center p-12">
                <div className="max-w-md">
                    <p className="data-label text-ink-500 mb-6">Nasıl Çalışır</p>
                    <div className="space-y-8">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h3 className="text-white font-medium mb-1">Tahmin yapın</h3>
                                <p className="text-ink-400 text-sm">Gerçek dünya olayları gerçekleşmeden önce Evet veya Hayır oyu verin.</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="w-8 h-8 bg-ink-800 rounded flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <h3 className="text-white font-medium mb-1">Puanınızı oluşturun</h3>
                                <p className="text-ink-400 text-sm">Doğru tahminler zaman içinde güven puanınızı artırır.</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="w-8 h-8 bg-ink-800 rounded flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <h3 className="text-white font-medium mb-1">Etki kazanın</h3>
                                <p className="text-ink-400 text-sm">Yüksek puanlar, oylarınızın daha fazla ağırlık taşıması anlamına gelir.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center px-8">
                <div className="w-full max-w-sm">
                    ...
                    <h1 className="font-display text-2xl headline mb-2">Hesap oluştur</h1>
                    <p className="text-ink-500 mb-8">
                        Tahmin geçmişinizi oluşturmaya başlayın
                    </p>
                    ...
                    <form action={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 bg-white border border-ink-200 rounded text-sm focus:outline-none focus:border-ink-400 disabled:opacity-50 placeholder:text-ink-300"
                            />
                            <p className="text-xs text-ink-400 mt-1">En az 8 karakter</p>
                        </div>
                        <button
                            type="submit"
